    ...
    <div className="w-full overflow-hidden">
      ...
      <section className="py-24 bg-white" id="services">
        <div className="max-w-[1280px] mx-auto px-4 md:px-16 text-left">
          <div className="reveal-slide-up flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
            <div className="max-w-2xl">
              <span className="text-secondary font-bold text-xs uppercase tracking-widest">{COMPANY_INFO.slogan}</span>
              <h2 className="font-headline-lg text-3xl font-bold text-primary mb-2 mt-1">Our Gas Pipeline Services</h2>
              <p className="font-body-md text-on-surface-variant text-base">Comprehensive gas infrastructure solutions tailored to domestic residences, commercial kitchens, apartment flats, chemistry labs, and industrial facilities.</p>
            </div>
            <Link
              to="/services"
              className="text-primary font-label-md border-b-2 border-secondary-container hover:text-secondary transition-all font-semibold pb-1 self-start md:self-auto"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {PRIMARY_SERVICES.map((srv, i) => (
              <div
                key={i}
                data-delay={`${i * 100}ms`}
                className="reveal-stagger-item group p-8 bg-surface-container-low rounded-3xl border border-outline-variant/30 hover:border-secondary-container transition-all hover:shadow-xl hover:-translate-y-2 flex flex-col justify-between"
              >
                <div>
                  ...
                  <h3 className="font-headline-md text-xl font-bold mb-3 text-primary group-hover:text-secondary transition-colors">{srv.title}</h3>
                  <p className="font-body-md text-on-surface-variant mb-6 text-xs leading-relaxed">{srv.excerpt}</p>
                </div>
                <div>
                  <Link
                    to={`/services/${srv.id}`}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="reveal-slide-left space-y-6">
              ...
              <div className="flex flex-wrap gap-4 pt-4">
                <button
                  onClick={() => navigate('/contact')}
                  className="bg-secondary-container text-on-secondary px-8 py-3.5 rounded-xl font-headline-md font-bold text-sm hover:opacity-90 transition-all cursor-pointer shadow-lg"
                >
                  Talk To An Expert
                </button>
                <button
            ...
            >
              ...
              <div className="absolute bottom-4 left-4 bg-primary/80 backdrop-blur-md px-4 py-2 rounded-lg text-xs font-bold text-white border border-white/10">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-[1280px] mx-auto px-4 md:px-16">
          <div className="reveal-slide-up mb-16 text-center max-w-2xl mx-auto">
            ...
            <h2 className="font-headline-lg text-3xl font-bold text-primary mb-4 mt-1">Specialized Pipeline Systems & Equipment</h2>
            <p className="font-body-md text-on-surface-variant text-base">From high-efficiency gas filtration to precision gas control panels, auto leak shut-off systems, and modular expansions.</p>
          </div>
            ...
            {OTHER_SERVICES.filter(srv => srv.id !== 'gas-control-panel-system' && srv.id !== 'leakage-detection-system').map((srv, idx) => (
              ...
              >
                <div>
                  ...
                  <h3 className="font-headline-md text-lg font-bold mb-3 text-primary">{srv.title}</h3>
      ...
      <section className="py-24 bg-surface-container-low border-y border-outline-variant/30 text-left relative overflow-hidden">
        <div className="max-w-[1280px] mx-auto px-4 md:px-16">
          <div className="reveal-slide-up text-center max-w-2xl mx-auto mb-16">
            <span className="text-secondary font-bold text-xs uppercase tracking-widest">Pathways to Expansion</span>
            <h2 className="font-headline-lg text-3xl font-bold text-primary mt-1 mb-4">Opportunities With Centralized Gas Pipeline</h2>
            <p className="font-body-md text-on-surface-variant text-base">Designed for scalability, seamless maintenance, and long-term operating profitability.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {OPPORTUNITIES_DATA.map((opp, idx) => (
              ...
              >
                <div className="w-14 h-14 rounded-2xl bg-secondary-container/10 text-secondary-container flex items-center justify-center shrink-0">
                  <span className="material-symbols-outlined text-3xl">{opp.icon}</span>
                </div>
                <div className="space-y-3">
                  <h3 className="font-headline-md text-xl font-bold text-primary">{opp.title}</h3>
        ...
        <div className="max-w-[1280px] mx-auto px-4 md:px-16 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="reveal-slide-left space-y-6">
              ...
              <div className="pt-2">
                <h4 className="font-headline-md text-xs font-bold text-secondary-container uppercase tracking-wider mb-4">
            ...
            <div className="reveal-slide-right relative rounded-3xl overflow-hidden shadow-2xl border border-white/20">
              ...
              <div className="absolute bottom-4 left-4 right-4 bg-primary/90 backdrop-blur-md p-4 rounded-2xl border border-white/10 text-xs">
                <p className="font-bold text-white">Seamless Scaling & Retrofit Assurance</p>
                <p className="text-white/70 text-[11px] mt-1">Pre-engineered takeoff points eliminate downtime during future capacity increases.</p>
              </div>
            </div>
              ...
              >
                ...
                <div className="flex-1">
                  <div className="flex items-center justify-between mb-1.5">
                    ...
                    <span className="text-[10px] font-bold uppercase px-2 py-0.5 rounded bg-secondary-container/10 text-secondary">
                      Step 0{step.num}
                    </span>
                  </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-center">
            ...
            <div className="reveal-slide-left space-y-6 text-left">
              ...
              <div className="space-y-6 pt-2">
                <div className="bg-surface-container-low p-6 rounded-2xl border-l-4 border-secondary-container shadow-sm">
                  <h4 className="font-headline-md font-bold text-base text-primary mb-1">{OFFICE_LOCATIONS.headOffice.title}</h4>
                ...
                <div className="bg-surface-container-low p-6 rounded-2xl border-l-4 border-primary shadow-sm">
                  <h4 className="font-headline-md font-bold text-base text-primary mb-2">Safe. Smart. Economical.</h4>
            ...
            <div className="reveal-slide-right lg:col-span-2 relative bg-surface-container-low p-8 rounded-3xl border border-outline-variant/30 text-center">
              ...
              <div className="mt-4 font-body-sm text-xs font-bold text-on-surface-variant">
                Serving Coimbatore, Tamil Nadu, All Major Commercial Hubs, Industrial Plants & Domestic Residencies.
              </div>
            </div>
      ...
      <section className="py-24 bg-primary text-white overflow-hidden">
        <div className="max-w-[1280px] mx-auto px-4 md:px-16">
          <div className="reveal-slide-up text-center max-w-2xl mx-auto mb-12">
            <span className="text-secondary-fixed-dim font-bold text-xs uppercase tracking-widest">Client Testimonials</span>
            <h2 className="font-headline-lg text-2xl sm:text-3xl md:text-4xl font-bold text-white mt-2">Listen To Our Client's Feedback</h2>
            <p className="font-body-md text-xs sm:text-sm text-white/70 mt-2">Hear directly from homeowners, commercial hospitality partners, and industrial clients.</p>
          </div>
