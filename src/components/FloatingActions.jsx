...
export default function FloatingActions() {
  ...
  // 4 Social Platforms inside the merged launcher (Instagram, YouTube, LinkedIn, Facebook)
  ...
  return (
    ...
    >
      ...
      {/* 3. Merged Social Media Launcher Button & Expanded Menu (Instagram, YouTube, LinkedIn, Facebook) */}
      <div ref={socialRef} className="relative flex items-center justify-end">
        
        {/* 4 Expanded Platform Icons (Slides out to the left with staggered spring/ease transition) */}
        <div
        ...
        <div className="relative flex items-center group">
          ...
          <button
            ...
            aria-label={isSocialOpen ? "Close social media channels menu" : "Open social media channels (Instagram, YouTube, LinkedIn, Facebook)"}
      ...
      {/* 4. Dedicated Individual WhatsApp Floating Button */}
      <div className="relative flex items-center group">
        {/* Tooltip (Desktop Only) */}
        <div
